...
try:
    ...
    version = '0.1'
    project = u'ska'
    copyright = u'2014-2016, Artur Barseghyan <artur.barseghyan@gmail.com>'
...
latex_documents = [
  ('index', 'ska.tex', u'ska Documentation',
...
texinfo_documents = [
  ('index', 'ska', u'ska Documentation',
   u'Artur Barseghyan <artur.barseghyan@gmail.com>', 'ska',
