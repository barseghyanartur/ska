...
class Client1Create(object):
    ...
    def power_users(user, request, signed_request_data):
        ...
        user.is_staff = True
        user.save()
        return Client1Create._send_email(_('power users'), user, request, signed_request_data)
    ...
    def admins(user, request, signed_request_data):
        ...
        user.is_staff = True
        user.save()
        return Client1Create._send_email(_('admins'), user, request, signed_request_data)
