...
__all__ = ('extract_signed_request_data', 'sign_url', 'signature_to_dict', 'validate_signed_request_data',)

from ska.defaults import (
    SIGNATURE_LIFETIME, DEFAULT_URL_SUFFIX,
...
def sign_url(auth_user, secret_key, valid_until=None, lifetime=SIGNATURE_LIFETIME, url='', \
             ...
             extra={}, extra_param=DEFAULT_EXTRA_PARAM, signature_cls=Signature):
    """
    Signs the URL.
